...
\cvcomputer{Strengths}{Excellent \emph{Team Player}, collaborative with colleagues, very good at avoiding and managing conflicts; good in \emph{sharing knowledge}; good \emph{motivator}; \emph{passionate} and \emph{curious}; motivated in \emph{self-improving}; striving for excellence in all its aspects; good ability in \emph{communication}; \emph{proactive and self-driven}; precise and \emph{meticulous}; \emph{energetic}; \emph{non conventional thinking} is appreciated}{Weaknesses}{Problems when working in \emph{strict not-understandable rules}; problems when only working on \emph{repetitive} and not creative tasks; frustrated when forced to \emph{maximize quantity and not quality}; might show frustration if \emph{isolated for too long}; might suffer in environments with low level of organization; \emph{non conventional thinking} is appreciated}
